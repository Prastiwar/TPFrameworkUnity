...
{
    public class SlotsSpawnBehaviour : MonoBehaviour
    {
        ...
        public EquipSlotHoldBehaviour[] SpawnEquipSlots()
        {
            return Spawn<EquipSlotHoldBehaviour>(equipSlotsCount, equipSlotPrefab, equipSlotsPanel);
        }

        /// <summary> Returns array of spawned slots layout </summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public ItemSlotHoldBehaviour[] SpawnItemSlots()
        {
            return Spawn<ItemSlotHoldBehaviour>(itemSlotsCount, itemSlotPrefab, itemslotsPanel);
        }
        ...
        {
            equipSlotPrefab = equipSlotPrefab != null ? CheckNull<EquipSlotHoldBehaviour>(equipSlotPrefab) : equipSlotPrefab;
            itemSlotPrefab = itemSlotPrefab != null ? CheckNull<ItemSlotHoldBehaviour>(itemSlotPrefab) : itemSlotPrefab;
        }
